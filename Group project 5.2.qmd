...
"ccmarzer/Group_project/Group project 5.2.qmd"
```
...
content_analysis |> count() |> filter(n > 1)
```

**Split the data**

Split data into different tables. The code below creates a table from the responders dataset that containts the responders characterstics.
...
For the debate and content analysis data set, the foreign key is a time string of hours:minutes:seconds.
