...
When joining the data, it is important to understand the types of relations between the tables. There are three types of relationships possible. A one-to-one relationship is when a record in one table is related to one record in another table. A one-to-many relationship is when a record in one table is related to many records in another table. A many-to-many relationship is when multiple records in one table are related to multiple records in another table.
...
The four individual research questions formulated with the GLES 2009 data are shown (again) below, to refresh your memory. Furthermore, the steps in data wrangling that are necessary to answer each question and the visualization are presented and discussed in detail. The author of the visualization of research question one is Mattia Guarnerio. The author of the visualization of research question two is Lixin Lakeman. The author of the visualization of research question three is Margarita. The author of the visualization of research question four is Iria Cheng.
