...
The GLES data can be imported using the readr package that is part of the tidyverse on responders' political behaviour and live reactions during the TV duel, and on the debate's contents and dynamics.
