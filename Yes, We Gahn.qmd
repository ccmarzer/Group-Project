...
This project aims to bring the "most boring" debate alive through visualizations, which require prior data wrangling in R. We work with the GLES 2009 data, a complex data set that consists of information about the responders, live reactions during the debate, and the TV duel's content. First, the research questions formulated in reference to the complex data set are presented. Then, the steps for tidying the complex data set are discussed in detail. The data joining process is described next, followed by a description of the scope of the data. Four visualizations that answer the earlier stated research questions are discussed in detail and presented. For this project, the `tidyverse` package is used to wrangle and visualize the data. `tidyverse` is an opinionated collection of R packages designed for data science. Packages that are part of the `tidyverse` are: `readr`, `dplyr`, `tibble`, `purrr`, `tidyr`, `forcats`, `stringr`, and `ggplot2`. All packages share an underlying design philosophy, grammar, and data structures.
