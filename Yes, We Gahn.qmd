...
The figure above shows the average live impressions regarding Steinmeier and Merkel during the entire live debate. It visualizes the average impressions per four age groups (young-adults, adults, middle-aged and senor), and within each age group a distinction between female and male responders is made. As the figure shows, there are no big difference between the age groups and within the groups between males and females. In all four age groups, males and females are close to the gray solid reference line, and thus have a neutral impression regarding Steinmeier and Merkel. Altough, senior male responders are an exception. This group deviates on average more from the neutral line and seem to have a more positive impression of Merkel than senior female responders or male and female responders in the other three age groups.

Another remarkable difference is between the young-adults and the senior voters. If you look at the young-adults, you can see that throughout the entire debate, female responders on average are above the neutral line, and thus have a better impression of Merkel. The young-adult male responders are on average throuhout the entire debate below the neutral score and thus have a better impression of Steinmeier. In the senior group, this is opposite. Throughout the debate, senior male responders have on average a more positive impression of Merkel, while senior female responders have a more positive impression of Steinmeier.
...
Nevertheless, it should be noted that the plot is zoomed in on the y-axis: it only shows a impression score of 2.7-3.5 while the full scale ranges from 0-6. So in general, it can be concluded that the the impressions regarding Steinmeier and Merkel stayed quite neutral throughout the debate. Throughout the debate there are some differences between male and female voters within different age groups, although these differences are quite small.s
