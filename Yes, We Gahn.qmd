...
ggplot(aes(x = time, y = score_avg_time, group = as.factor(Gender_rc), color = as.factor(Gender_rc))) +
  ...
  geom_hline(yintercept = 3, linetype = "dashed", color = "chartreuse2", linewidth = 1.80) +
  annotate("text", x = 4776, y = 2.95, label = "Neutral", color = "chartreuse2") +
  scale_x_time() +
  facet_wrap(~Age_rc) +
  ...
  theme(legend.position = "bottom",
    ...
    plot.caption = element_text(hjust = c(1, 0), size = 6),
